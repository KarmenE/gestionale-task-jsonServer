Questo progetto Angular è un'applicazione web semplice per la gestione di task. Utilizza un backend simulato fornito da JSON Server per la persistenza dei dati.
